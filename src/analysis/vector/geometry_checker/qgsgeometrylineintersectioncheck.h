...
class ANALYSIS_EXPORT QgsGeometryLineIntersectionCheck : public QgsGeometryCheck
{
  public:
    ...
    {}
    QList<QgsWkbTypes::GeometryType> factoryCompatibleGeometryTypes() const {return {QgsWkbTypes::LineGeometry};}
    ...
    QString id() const override { return QStringLiteral( "QgsGeometryLineIntersectionCheck" ); }
