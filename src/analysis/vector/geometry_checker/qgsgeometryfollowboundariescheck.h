...
class ANALYSIS_EXPORT QgsGeometryFollowBoundariesCheck : public QgsGeometryCheck
{
  public:
    ...
    QList<QgsWkbTypes::GeometryType> compatibleGeometryTypes() const override {return {QgsWkbTypes::PolygonGeometry};}
    ...
    QString description() const override { return tr( "Polygon does not follow boundaries" ); }
    QString id() const override { return QStringLiteral( "QgsGeometryFollowBoundariesCheck" ); }
  private:
